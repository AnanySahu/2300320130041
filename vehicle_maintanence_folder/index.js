...
// Endpoint 2: Get optimal schedule for specific depot
app.get('/schedule/:depotId', async (req, res) => {
    ...
    try {
        ...
        // Map vehicles with correct field names (capital D and I)
...
// Endpoint 3: Custom optimization with custom hours
